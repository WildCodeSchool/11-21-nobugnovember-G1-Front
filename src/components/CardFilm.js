    ...
    <div>
      <div className='cardFilm'>
        <div className='cardFilmContainer'>
          ...
          <div className='infoContainer'>
            ...
            <div className='holderInfo'>
              ...
              <div className='synopsis'>
                <p>
                  Arthur Fleck, comédien raté, rencontre des voyous violents en
                  errant dans les rues de Gotham City déguisé en clown. Méprisé
                  par la société, Fleck s'enfonce peu à peu dans la démence et
                  devient le génie criminel connu sous le nom de Joker, un
                  dangereux tueur psychotique.
                </p>
                <button className='playButton'>Play</button>
              </div>
              <p className='infoProd'>
                {' '}
                <span className='textGrey'>Producteur :</span> Todd Phillips{' '}
              </p>
              <p className='infoProd'>
                {' '}
                <span className='textGrey'>Scénario :</span> Todd Phillips,
                Scott Silver, Bob Kane{' '}
              </p>
              <p className='infoProd'>
                {' '}
                <span className='textGrey'>Studio :</span> Warner Bros., Village
                Ro…llage Roadshow Pictures{' '}
              </p>
              <p className='infoProd'>
                {' '}
                <span className='textGrey'>Genres :</span> Crime, Drame,
                Thriller
              </p>
            </div>
          ...
          <div></div>
          <iframe
            src='https://uqload.org/embed-na65en0j8853.html'
            frameBorder='0'
            marginWidth='0'
            marginHeight='0'
            scrolling='NO'
