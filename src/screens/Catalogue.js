...
const Catalogue = props => {
  ...
  useEffect(() => {
    const appelAPI = () => {
      ...
      axios
        .get(
          `https://imdb-api.com/API/AdvancedSearch/${apiKey}?title_type=${titleType}&genres=${props.emojiSelected.correspondance}&count=100` /* Requête de 50 le temps de dev, penser à remettre à 100 */
        )
